...
test_traj_seq:log.o utils.o test_traj_seq.o socket.o config.o torus-node.o  
	$(CC) $(CFLAGS) -o $(BIN)/$@ $(BIN)/utils.o $(BIN)/test_traj_seq.o $(BIN)/socket.o $(BIN)/config.o $(BIN)/torus-node.o $(BIN)/log.o
test_traj_seq.o: 
